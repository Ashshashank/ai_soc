...
This project was initially developed by Abdul Bari. It is currently maintained and actively developed by Shashank Adepu.

---

## About the Maintainer

This project is currently maintained by Shashank Adepu, an AI Engineer and Data Engineer with a focus on scalable AI, machine learning, and cloud data solutions. Shashank brings expertise in Python, LangChain, FastAPI, MLOps, Docker, and cloud-native data platforms, ensuring robust and efficient development of intelligent analytics solutions.
