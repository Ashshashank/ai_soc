...
```bash
# Clone repository
git clone https://github.com/shashank-adepu/AI_SOC.git
cd AI_SOC/services
...
- Shashank Adepu (adepushashank85@gmail.com)
- Original Research Context: CSUSB Cybersecurity Research
...
**Project Maintainer:** Shashank Adepu
...
Shashank Adepu is an AI and Data Engineer with over 5 years of experience designing scalable AI, machine learning, and cloud data solutions. He specializes in building intelligent analytics systems using Python, LangChain, and FastAPI, with a focus on RAG architectures and MLOps. His work centers on delivering data-driven insights and optimizing large-scale processing pipelines for enterprise efficiency.
