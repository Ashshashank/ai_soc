...
This project is currently maintained by Shashank Adepu.

Original research and initial implementation by Abdul Bari, California State University, San Bernardino.

## About the Maintainer

Shashank Adepu is an AI Engineer and Data Engineer with a passion for building scalable, intelligent solutions. With 5+ years of experience across various domains, Shashank specializes in Python, SQL, PySpark, and cloud data platforms, focusing on MLOps, LangChain, and RAG architectures.
